...
latex_documents = [
  ('index', 'crush.tex', u'crush documentation',
   u'Loic Dachary', 'manual'),
]
...
man_pages = [
    ('index', 'crush', u'crush documentation',
     [u'Loic Dachary'], 1)
]
...
texinfo_documents = [
  ('index', 'crush', u'crush documentation', u'Loic Dachary',
   'crush', 'One line description of project.', 'Miscellaneous'),
]
